...
% Author
\author{Octávio José Azevedo Maia}
...
\begin{document}
	...
	% Anexo 3 ------------------------------------------
    \input{sections/0_anexo3.tex}
	
	% Add acknowledgements -----------------------------
    %\input{0_acknowledgements.tex}

    % Anexo 4 ------------------------------------------
    \input{sections/0_anexo4.tex}

	% Resumo ------------------------
	\cleardoublepage
	\input{sections/0_resumo.tex}
    ...
    % CHAPTER - Solution -----------------------
    \input{sections/3_solucao.tex}

    % CHAPTER - Implementation -----------------------
    \input{sections/4_implementacao.tex}
	...
	\input{sections/5_conclusao.tex}
